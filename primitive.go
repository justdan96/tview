...
type Primitive interface {
  BasicPrimitive
  SetEventedFunc(f EventedFunc) *Box
  GetEventedFunc() EventedFunc
Event(f EventerFunc)
}
...
type EventerFunc func(f EventedFunc)
type EventedFunc func(event string, p Primitive, i ...any)
